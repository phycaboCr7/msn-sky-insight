...
import { Cloud, Moon, CloudRain, CloudSnow, Snowflake, Sun, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    <WeatherCard className="p-6 col-span-full animate-slide-left">
      ...
      <div className="relative">
        <ScrollArea className="w-full whitespace-nowrap">
          <div 
            ref={scrollRef}
            className="flex gap-4 pb-4 w-max min-w-full overflow-x-auto scrollbar-hide"
          >
